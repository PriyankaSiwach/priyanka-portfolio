...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Built Applyfy, an AI job platform integrating OpenAI GPT-4o across 12 features, protected by Redis-backed rate limiting (5 req/min/user), reaching 36 signups. Engineered a serverless AWS resume-parsing pipeline (API Gateway, Lambda, S3, DynamoDB, WAF, CDK).",
    details: [
      "Integrated OpenAI GPT-4o across 12 features with Redis-backed rate limiting (5 req/min/user), reaching 36 signups",
      "Built a serverless AWS resume-parsing pipeline with API Gateway, Lambda, S3, DynamoDB, WAF, and CDK",
      "Diagnosed and isolated two independent throttling layers (WAF edge rate limiting vs. Lambda account concurrency) under 50-request concurrent load",
      "Sustained 45 req/sec at 1.9s latency for legitimate traffic after isolating the throttling bottlenecks",
    ],
